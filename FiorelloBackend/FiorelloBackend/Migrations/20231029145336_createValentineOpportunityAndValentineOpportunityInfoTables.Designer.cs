...
namespace FiorelloBackend.Migrations
{
    ...
    [Migration("20231029145336_createValentineOpportunityAndValentineOpportunityInfoTables")]
    partial class createValentineOpportunityAndValentineOpportunityInfoTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FiorelloBackend.Models.ValentineOpportunityInfo", b =>
                {
                    ...
                    b.Property<string>("ValentineOpportunityId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("ValentineOpportunityId1")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("ValentineOpportunityId1");
            ...
            modelBuilder.Entity("FiorelloBackend.Models.ValentineOpportunityInfo", b =>
                {
                    b.HasOne("FiorelloBackend.Models.ValentineOpportunity", "ValentineOpportunity")
                        .WithMany("ValentineOpportunityInfos")
                        .HasForeignKey("ValentineOpportunityId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FiorelloBackend.Models.ValentineOpportunity", b =>
                {
                    b.Navigation("ValentineOpportunityInfos");
                });
